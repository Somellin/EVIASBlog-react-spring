...
import com.kirill.kamelyazev.eviasblog.payload.request.LoginRequest;
import com.kirill.kamelyazev.eviasblog.payload.request.SignupRequest;
import com.kirill.kamelyazev.eviasblog.payload.response.JwtResponse;
...
import com.kirill.kamelyazev.eviasblog.security.jwt.JwtUtils;
import com.kirill.kamelyazev.eviasblog.security.services.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        List<Post> posts = userDetails.getPosts();
